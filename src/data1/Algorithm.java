...
public class Algorithm {
    ...
    private static final int tournamentSize = 5; //0-10
    private static final boolean elitism = true; //true/false
    ...
    // Crossover individuals (Parameters: 2 parents)
    private static Individual crossover(Individual indiv1, Individual indiv2) {
        Individual newSol = new Individual();
        //crossover crosspoint
        int crosspoint = 0;
        //get crossover point (rulesize * noOfRules)
        crosspoint = (int) ((int) Rule.getRuleSize() * 
